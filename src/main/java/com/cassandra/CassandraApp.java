...
import com.cassandra.config.ApplicationProperties;
import com.cassandra.config.DefaultProfileUtil;
...
public class CassandraApp {
    ...
    public CassandraApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Cassandra.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CassandraApp.class);
